...
def run_linear(
    ...
    model = basic_building_blocks.Linear(d_in, d_out)
...
def run_embedding(
    ...
    model = basic_building_blocks.Embedding(vocab_size, d_model)
...
def run_swiglu(
    ...
    model = pre_norm_transformer_block.SwiGLU(d_model, d_ff)
    model.load_state_dict({'w1.weights': w1_weight, 'w2.weights': w2_weight, 'w3.weights': w3_weight})
    return model(in_features)
...
def run_scaled_dot_product_attention(
    ...
    """
    return pre_norm_transformer_block.scaled_dot_product_attention(Q, K, V, mask)
...
def run_rope(
    ...
    """
    model = pre_norm_transformer_block.RoPE(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    model = pre_norm_transformer_block.RMSNorm(d_model, eps)
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    return pre_norm_transformer_block.silu(in_features)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return pre_norm_transformer_block.softmax(in_features, dim)
